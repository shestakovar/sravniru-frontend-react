...
const ProposalItem: FC<ProposalItemProps> = ({ proposal }) => {
  ...
  return (
    <div className={classes.proposal_item}>
      <div className={`${classes.proposal_item__img_col}`}>
      ...
      <div className={`${classes.proposal_item__descr_col}`}>
      ...
      <div className={`${classes.proposal_item__button_col}`}>
        <div className={`${classes.more__wrapper} ${classes.proposal_item__col}`}>
          ...
          <MyButton className={`${classes.proposal_item__col_item}`} text="Подробнее"
                    onClick={() => history.push(`/${proposal.id}`)}/>
        </div>
      </div>
    </div>
  );
